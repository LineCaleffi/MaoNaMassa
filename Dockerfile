# partimos de uma imagem padrão do JAVA 11 para a construção da imagem docker do nosso micro serviço
FROM adoptopenjdk/openjdk11:alpine

# RUN -> é utilizado para executar comando no "terminal" do micro serviço
# APK -> é utilizado para atualizar os repositórios que o container pode fazer download
# apk add bash -> é utilizado para adicionar o bash(shell script - linguagem de terminal)
